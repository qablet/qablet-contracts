...
│   ├── bond                 # Create bond related contracts
│   ├── commodity            # Create commodity contracts
│   ├── equity               # Create equity contracts
│   ├── rate                 # Create rate derivatives
│   ├── __init__.py          # This tells Python that this is a package
│   ├── timetable.py         # Common utilities to create timetable
